...
It has different shift rules for uppercase and lowercasae letters.
The character without letter remain unchanged. 
...
Major features:
Supports + - * /
Can handle parentheses 
Also support unary negative like -8 and supports implicit multiplication like 6(9-1)
